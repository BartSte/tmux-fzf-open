...
preview="$(fzf_open_opt '@fzf-open-preview' true)"
fzf_opts="$(fzf_open_opt '@fzf-open-fzf-opts' '')"

tmux bind-key "$key" run -b "$script_dir/fzf-open $regex $regex_extra $limit $open_cmd $sort_cmd $preview $fzf_opts"
